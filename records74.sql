...
CREATE TABLE `Appdata` (
  ...
  `host_kingdom_id` smallint(6) NOT NULL,
  PRIMARY KEY (`app_id`)
...
CREATE TABLE `Invites` (
  `invite_id` smallint(6) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `WebUsers` (
  ...
  `id_person` int(11) DEFAULT NULL,
  `hash_webuser` char(255) DEFAULT NULL,
...
-- Dump completed on 2022-06-06 19:47:52
