...
<h2>	Welcome to the Hall of Records for Gleann Abhann, where we maintain a variety of information.</h2>
...
The Awards section of the site reflects the Order of Precedence of Gleann Abhann.  It is possible to search for people, groups, awards, or events using the handy search box and a partial name.
...
<div class="col-lg-7 col-lg-offset-2 col-md-7 col-md-offset-2 col-xs-12">
    ...
    <p class="text-justify"><small>
This website was created by a team of volunteers working under the direction of the Webminister's Office.  As always, all mistakes made are owned by the webminister; all redit goes to her team of Rabid Programming Squirrels.
</small>
      </p>
</div>
<div class="col-lg-3 col-md-3 hidden-xs">
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <h2 class="text-center">Authorizations</h2>
        ...
        See lists of active marshals by type of comb by type of combat</p>
        <p><a class="btn btn-default" href="#" role="button">View Authorizations &raquo;</a></p>
        <p class="text-justify">
        See the authorizations of an individual by searching for that person.
        <form role="search" action="public/search.php" method="get">
                  <input type="text" class="form-control" placeholder="Search for Name or Award" name="name">
                <button type="submit" class="btn btn-default">Submit</button>
       </p>
