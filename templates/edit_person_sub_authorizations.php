...
while ($row = $sth_auths->fetch(PDO::FETCH_ASSOC)) {
    ...
    if ($curr_id_combat!= $id_combat) {// Build for the next item in combats
        ...
        echo "<div class='col-lg-4'><!-- begin fields col -->";
        // create active/not active pulldown with active status selected
        // ipcc = 'id_person_combat_card'
        if ($combat["ipcc"] != null) {
            echo "<div class='col-xs-12 form-group'><!--begin active row-->";
            ...
            echo "</select>";
            echo "</div><!--end active row-->";
        }

        // expiration date, card number, and note fields
        echo "<div class='col-xs-12 form-group'><!--begin exp date row-->";
        echo "<label class='form-label' for='dyndate[$id_combat]'>expires:</label>"
                ...
                . "</div><!-- end expiration date row --><div class='col-xs-12 form-group'><!--begin card num row-->"
        ...
        echo "<div class='col-lg-8'><!--begin auth cards col-8--><div class='row mx-1'><!-- begin auths cards -->";
    }
    ...
    echo "<div class='col-xs-6 col-sm-4 col-md-3 form-group'><!-- begin single card column -->";
    ...
    echo "></div><!--end of auth card-body-->"
      . "</div><!-- end of $name_auth card -->"
